...
#include "ui_placesmenuconfiguration.h"


PlacesMenuConfiguration::PlacesMenuConfiguration(PluginSettings *settings, QWidget *parent) :
    LXQtPanelPluginConfigDialog(settings, parent),
    ui(new Ui::PlacesMenuConfiguration),
    mBaseDirectory(QDir::homePath()),
    mDefaultIcon(XdgIcon::fromTheme("folder"))
{
    setAttribute(Qt::WA_DeleteOnClose);
    setObjectName("PlacesMenuConfigurationWindow");
    ui->setupUi(this);
...
PlacesMenuConfiguration::~PlacesMenuConfiguration()
{
    delete ui;
}

void PlacesMenuConfiguration::loadSettings()
{
...
void PlacesMenuConfiguration::saveSettings()
{
    settings().setValue("baseDirectory", mBaseDirectory.absolutePath());
    settings().setValue("icon", mIcon);
}

void PlacesMenuConfiguration::showDirectoryDialog()
{
...
void PlacesMenuConfiguration::showIconDialog()
{
